...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('polls', '0029_rename_admission_admissions'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='admission',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='addHostel', to='polls.admission'),
        ),
