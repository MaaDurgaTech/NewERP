# Generated by Django 3.2.2 on 2021-05-29 08:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addclass', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='admissions', to='polls.addclass')),
                ('busRoot', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='admissions', to='polls.busroot')),
                ('reception', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='admissions', to='polls.reception')),
            ],
        ),
    ]
